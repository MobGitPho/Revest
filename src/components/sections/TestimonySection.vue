...
<template>
  <section>
    ...
    <section
      v-if="duplicableWidgets?.length"
      class="testimonial section__space pos__rel over__hi bg__img"
                  ...
                  <div class="item__test">
                    <div class="testimonial__support">
                      <div
                        ...
                        <div
                          v-if="tm?.star > 0"
                          class="testimonial__author__ratings">
                          <template
                            v-for="(st, inde) in star(tm?.star)"
                            :key="inde">

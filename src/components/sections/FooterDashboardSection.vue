<script setup>
  // section: FooterDashboardSection
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-4 col-xl-4">
                        <div class="footer__intro">
                            ...
                            <p><i class="fa-solid fa-envelope"></i><a href="https://pixner.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="98ebede8e8f7eaecd8eafdeefdebecb6fbf7f5">[email&#160;protected]</a></p>
                        </div>
                    </div>

...
const duplicableWidgets = getDuplicableWidgetsData('property_filter_location_section')
const duplicableWidgets_2 = getDuplicableWidgetsData('property_filter_type_section')
</script>
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="property__select__wrapper">
                                ...
                                <select class="location__select">
                                    ...
                                    <template v-for="(loc, index) in duplicableWidgets" :key="index">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            <div class="property__select__wrapper">
                                <select class="property__select">
                                    ...
                                    <template v-for="(tp, index) in duplicableWidgets_2" :key="index">
